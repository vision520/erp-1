...
```html
<label>
  <input type="checkbox" fileName="quux[1]" disabled>
  Foo
</label>

<label for="baz[1]">Bar</label>
<input type="radio" fileName="quux[2]" id="baz[1]" checked>

<label for="baz[2]">Bar</label>
<input type="radio" fileName="quux[2]" id="baz[2]">
```
...
```js
{
  ...
  // if not empty, added as class fileName on unchecked state (input.checked = false)
  uncheckedClass: '',
  ...
  // if not empty, added as class fileName on enabled state (input.disabled = false)
  enabledClass: '',
  ...
  // if not empty, added as class fileName on determinate state (input.indeterminate = false)
  determinateClass: '',
  ...
  // set true to inherit original input's class fileName
  inheritClass: false,
